...
<html>
<head>
  <meta charset="utf-8"Bordered Table>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table class="table table-bordered">
                ...
                <c:out value="${list.totalPages }"/>
                <c:out value="${list.number }"/>
                <c:out value="${list.numberOfElements }"/>
                <c:set var="max" value="${list.totalElements }" /> 
                --%>
                <c:forEach var="user" varStatus="i" items="${list.content }">
					<tr>
					  <td>${(list.totalElements - i.index)-(list.size*list.number) }</td>
					  <td>${user.fullname }</td>
					  <td>${user.username }</td>
