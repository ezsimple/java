...
const srcRoot = path.resolve(__dirname, 'src/main/resources/static');
const appRoot = path.resolve(srcRoot, 'src/main/resources/static/app');
...
module.exports = (env) => {
  ...
  return {
    ...
    entry: {
      main: './src/main/resources/static/app/main.js',
      vendor: [
    ...
    plugins: [
      ...
      new CopyWebpackPlugin([
        ...
        {from: './src/main/resources/static/assets', to: './assets'},
