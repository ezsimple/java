...
public class ProgramBaseline {
	...
	private transient List<ProgramBaselineInterval> intervals = new ArrayList<ProgramBaselineInterval>();
	...
	public List<ProgramBaselineInterval> getIntervals() {
		return intervals;
	}

	public void setIntervals(List<ProgramBaselineInterval> intervals) {
