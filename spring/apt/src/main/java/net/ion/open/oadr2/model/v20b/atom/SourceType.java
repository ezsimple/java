...
public class SourceType implements Serializable, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            strategy.appendField(locator, this, "authorsAndCategoriesAndContributors", buffer, theAuthorsAndCategoriesAndContributors);
        }
        {
            String theBase;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            List<Object> theAuthorsAndCategoriesAndContributors;
            theAuthorsAndCategoriesAndContributors = (((this.authorsAndCategoriesAndContributors!= null)&&(!this.authorsAndCategoriesAndContributors.isEmpty()))?this.getAuthorsAndCategoriesAndContributors():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "authorsAndCategoriesAndContributors", theAuthorsAndCategoriesAndContributors), currentHashCode, theAuthorsAndCategoriesAndContributors);
        }
        {
            String theBase;
            theBase = this.getBase();
