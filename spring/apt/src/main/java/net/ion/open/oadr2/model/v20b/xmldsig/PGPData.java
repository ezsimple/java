...
public class PGPData implements Serializable, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            strategy.appendField(locator, this, "pgpKeyID", buffer, thePGPKeyID);
        }
        {
            byte[] thePGPKeyPacket;
            thePGPKeyPacket = this.getPGPKeyPacket();
            strategy.appendField(locator, this, "pgpKeyPacket", buffer, thePGPKeyPacket);
        }
        {
