...
import net.ion.open.oadr2.model.v20b.ei.EiEvent;
...
public class OadrDistributeEvent implements Serializable, Equals, HashCode, ToString
{
     ...
     * 
     */
    public OadrDistributeEvent(final EiResponse eiResponse, final String requestID, final String vtnID, final List<OadrEvent> oadrEvents, final String schemaVersion) {
