    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        super.appendFields(locator, buffer, strategy);
        {
            ...
            strategy.appendField(locator, this, "flickerPlt", buffer, theFlickerPlt);
        }
        {
            Long theFlickerPst;
            theFlickerPst = this.getFlickerPst();
            strategy.appendField(locator, this, "flickerPst", buffer, theFlickerPst);
        }
        {
            Long theHarmonicVoltage;
            theHarmonicVoltage = this.getHarmonicVoltage();
            strategy.appendField(locator, this, "harmonicVoltage", buffer, theHarmonicVoltage);
        }
        {
            Long theLongInterruptions;
            theLongInterruptions = this.getLongInterruptions();
            strategy.appendField(locator, this, "longInterruptions", buffer, theLongInterruptions);
        }
        {
            Long theMainsVoltage;
            theMainsVoltage = this.getMainsVoltage();
            strategy.appendField(locator, this, "mainsVoltage", buffer, theMainsVoltage);
        }
        {
            Short theMeasurementProtocol;
            theMeasurementProtocol = this.getMeasurementProtocol();
            strategy.appendField(locator, this, "measurementProtocol", buffer, theMeasurementProtocol);
        }
        {
            Long thePowerFrequency;
            thePowerFrequency = this.getPowerFrequency();
            strategy.appendField(locator, this, "powerFrequency", buffer, thePowerFrequency);
        }
        {
            Long theRapidVoltageChanges;
            theRapidVoltageChanges = this.getRapidVoltageChanges();
            strategy.appendField(locator, this, "rapidVoltageChanges", buffer, theRapidVoltageChanges);
        }
        {
            Long theShortInterruptions;
            theShortInterruptions = this.getShortInterruptions();
            strategy.appendField(locator, this, "shortInterruptions", buffer, theShortInterruptions);
        }
        {
            DateTimeInterval theSummaryInterval;
            theSummaryInterval = this.getSummaryInterval();
            strategy.appendField(locator, this, "summaryInterval", buffer, theSummaryInterval);
        }
        {
            Long theSupplyVoltageDips;
            theSupplyVoltageDips = this.getSupplyVoltageDips();
            strategy.appendField(locator, this, "supplyVoltageDips", buffer, theSupplyVoltageDips);
        }
        {
            Long theSupplyVoltageImbalance;
            theSupplyVoltageImbalance = this.getSupplyVoltageImbalance();
            strategy.appendField(locator, this, "supplyVoltageImbalance", buffer, theSupplyVoltageImbalance);
        }
        {
            Long theSupplyVoltageVariations;
            theSupplyVoltageVariations = this.getSupplyVoltageVariations();
            strategy.appendField(locator, this, "supplyVoltageVariations", buffer, theSupplyVoltageVariations);
        }
        {
            Long theTempOvervoltage;
            theTempOvervoltage = this.getTempOvervoltage();
            strategy.appendField(locator, this, "tempOvervoltage", buffer, theTempOvervoltage);
        }
        return buffer;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        if (!(object instanceof ElectricPowerQualitySummary)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final ElectricPowerQualitySummary that = ((ElectricPowerQualitySummary) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "flickerPlt", lhsFlickerPlt), LocatorUtils.property(thatLocator, "flickerPlt", rhsFlickerPlt), lhsFlickerPlt, rhsFlickerPlt)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "flickerPst", lhsFlickerPst), LocatorUtils.property(thatLocator, "flickerPst", rhsFlickerPst), lhsFlickerPst, rhsFlickerPst)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "harmonicVoltage", lhsHarmonicVoltage), LocatorUtils.property(thatLocator, "harmonicVoltage", rhsHarmonicVoltage), lhsHarmonicVoltage, rhsHarmonicVoltage)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "longInterruptions", lhsLongInterruptions), LocatorUtils.property(thatLocator, "longInterruptions", rhsLongInterruptions), lhsLongInterruptions, rhsLongInterruptions)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mainsVoltage", lhsMainsVoltage), LocatorUtils.property(thatLocator, "mainsVoltage", rhsMainsVoltage), lhsMainsVoltage, rhsMainsVoltage)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "measurementProtocol", lhsMeasurementProtocol), LocatorUtils.property(thatLocator, "measurementProtocol", rhsMeasurementProtocol), lhsMeasurementProtocol, rhsMeasurementProtocol)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "powerFrequency", lhsPowerFrequency), LocatorUtils.property(thatLocator, "powerFrequency", rhsPowerFrequency), lhsPowerFrequency, rhsPowerFrequency)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "rapidVoltageChanges", lhsRapidVoltageChanges), LocatorUtils.property(thatLocator, "rapidVoltageChanges", rhsRapidVoltageChanges), lhsRapidVoltageChanges, rhsRapidVoltageChanges)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "shortInterruptions", lhsShortInterruptions), LocatorUtils.property(thatLocator, "shortInterruptions", rhsShortInterruptions), lhsShortInterruptions, rhsShortInterruptions)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "summaryInterval", lhsSummaryInterval), LocatorUtils.property(thatLocator, "summaryInterval", rhsSummaryInterval), lhsSummaryInterval, rhsSummaryInterval)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "supplyVoltageDips", lhsSupplyVoltageDips), LocatorUtils.property(thatLocator, "supplyVoltageDips", rhsSupplyVoltageDips), lhsSupplyVoltageDips, rhsSupplyVoltageDips)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "supplyVoltageImbalance", lhsSupplyVoltageImbalance), LocatorUtils.property(thatLocator, "supplyVoltageImbalance", rhsSupplyVoltageImbalance), lhsSupplyVoltageImbalance, rhsSupplyVoltageImbalance)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "supplyVoltageVariations", lhsSupplyVoltageVariations), LocatorUtils.property(thatLocator, "supplyVoltageVariations", rhsSupplyVoltageVariations), lhsSupplyVoltageVariations, rhsSupplyVoltageVariations)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "tempOvervoltage", lhsTempOvervoltage), LocatorUtils.property(thatLocator, "tempOvervoltage", rhsTempOvervoltage), lhsTempOvervoltage, rhsTempOvervoltage)) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            Long theFlickerPlt;
            theFlickerPlt = this.getFlickerPlt();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "flickerPlt", theFlickerPlt), currentHashCode, theFlickerPlt);
        }
        {
            Long theFlickerPst;
            theFlickerPst = this.getFlickerPst();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "flickerPst", theFlickerPst), currentHashCode, theFlickerPst);
        }
        {
            Long theHarmonicVoltage;
            theHarmonicVoltage = this.getHarmonicVoltage();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "harmonicVoltage", theHarmonicVoltage), currentHashCode, theHarmonicVoltage);
        }
        {
            Long theLongInterruptions;
            theLongInterruptions = this.getLongInterruptions();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "longInterruptions", theLongInterruptions), currentHashCode, theLongInterruptions);
        }
        {
            Long theMainsVoltage;
            theMainsVoltage = this.getMainsVoltage();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mainsVoltage", theMainsVoltage), currentHashCode, theMainsVoltage);
        }
        {
            Short theMeasurementProtocol;
            theMeasurementProtocol = this.getMeasurementProtocol();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "measurementProtocol", theMeasurementProtocol), currentHashCode, theMeasurementProtocol);
        }
        {
            Long thePowerFrequency;
            thePowerFrequency = this.getPowerFrequency();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "powerFrequency", thePowerFrequency), currentHashCode, thePowerFrequency);
        }
        {
            Long theRapidVoltageChanges;
            theRapidVoltageChanges = this.getRapidVoltageChanges();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "rapidVoltageChanges", theRapidVoltageChanges), currentHashCode, theRapidVoltageChanges);
        }
        {
            Long theShortInterruptions;
            theShortInterruptions = this.getShortInterruptions();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "shortInterruptions", theShortInterruptions), currentHashCode, theShortInterruptions);
        }
        {
            DateTimeInterval theSummaryInterval;
            theSummaryInterval = this.getSummaryInterval();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "summaryInterval", theSummaryInterval), currentHashCode, theSummaryInterval);
        }
        {
            Long theSupplyVoltageDips;
            theSupplyVoltageDips = this.getSupplyVoltageDips();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "supplyVoltageDips", theSupplyVoltageDips), currentHashCode, theSupplyVoltageDips);
        }
        {
            Long theSupplyVoltageImbalance;
            theSupplyVoltageImbalance = this.getSupplyVoltageImbalance();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "supplyVoltageImbalance", theSupplyVoltageImbalance), currentHashCode, theSupplyVoltageImbalance);
        }
        {
            Long theSupplyVoltageVariations;
            theSupplyVoltageVariations = this.getSupplyVoltageVariations();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "supplyVoltageVariations", theSupplyVoltageVariations), currentHashCode, theSupplyVoltageVariations);
        }
        {
            Long theTempOvervoltage;
            theTempOvervoltage = this.getTempOvervoltage();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "tempOvervoltage", theTempOvervoltage), currentHashCode, theTempOvervoltage);
        }
