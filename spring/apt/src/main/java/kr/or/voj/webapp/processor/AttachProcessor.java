...
public class AttachProcessor implements ProcessorService{
	...
	public  Object execute(ProcessorParam processorParam) throws Exception {
		...
		while (it.hasNext()) {
			...
			for(MultipartFile file : files){
				...
				//파일을 저장소에 파일을 저장한다.
				saveFile(result, attachId, attachGroupId, "ATTACH", is, fileName, fileSize);
			}
		}
	...
	public static void saveFile(Map<String, List<Map<String, Object>>> result, String attachId, String attachGroupId, String kind, InputStream is, String fileName, long fileSize) throws Exception{
