...
<%//------------------------------------------------------------------------%>
	...
	<div class="unit_page" type="page" >
		<form id="form_" action="" method="post" enctype="multipart/form-data">
			...
			<input type="hidden" name="ui_id" value="ui_list">
...
<%//------------------------------------------------------------------------%>
			<table class="lst" border="0" cellspacing="0" cellpadding="0"  style="margin-bottom: 10px;">
						<tr><th class="" style="" label="ui_id" width="10">ui_id</th><th class="" style="" label="query_path" width="10">query_path</th></tr><%%>
			<c:forEach var="row" items="${rows }" varStatus="status">
	<tr class="row_${status.index + 1}">
		<td class="" style="" align="">
							<src:mk_field name="ui_id" values="${row }" isSearch="false" type="text_view" link="changePage('${'$'}{ui_id}')"  link_type="linkFnc" valid="notempty"  keyValid="" maxlength="30" label="ui_id" /> 
						</td>
					<td class="" style="" align="">
							<src:mk_field name="query_path" values="${row }" isSearch="false" type="text_view" link=""  link_type="linkLoad" valid="notempty"  keyValid="" maxlength="255" label="query_path" /> 
						</td>
					</tr>
...
<%//[[END_AUTO_GENERATED_SRC]]-360920324[[HASHCODE]]%>
