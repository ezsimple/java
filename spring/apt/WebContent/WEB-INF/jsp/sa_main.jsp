	...
	<body class="">
			...
			<div id="logo-group">
				...
				<span id="logo"> 
                    <a href="javascript:void(0);" id="show-shortcut" data-action="toggleShortcut">
                        <img src="../img/login/ioe_logo1.gif" alt="IoE Server">
                    </a>
                </span>
		...
		<aside id="left-panel">
			...
			<nav>
				<ul>
					<li>
						<a href="../-dr-home/.sh" title="Dashboard"><i class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">Dashboard</span></a>
					</li>
					<li>
						<a href="#"><i class="fa fa-lg fa-fw fa-desktop"></i> <span class="menu-item-parent">이벤트관리</span></a>
						<ul>
							<li>
		...
		<script type="text/javascript">
			function logout(){
		    	$.getJSON( "../logout.sh", function( data ) {
					var workspaceId = location.pathname.split('/')[1];
