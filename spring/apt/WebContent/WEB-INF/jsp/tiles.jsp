		...
		<header id="header">
			<div id="logo-group">
				...
				<span id="logo"> 
                    <%--<a href="javascript:void(0);" id="show-shortcut" data-action="toggleShortcut">--%>
                        <img src="../img/login/body_top_leftlogo.png" alt="IoE Server">
                    <%--</a>--%>
                </span>
			...
			<div class="pull-right">
				...
				<ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
					<li class="">
						<a href="#" class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown"> 
							...
							${session.user_name } (${session.org_user_id })
						</a>
				...
				<div id="logout" class="btn-header transparent pull-right">
					<span> <a href="javascript:logout();" title="Sign Out" data-action="userLogout" data-logout-msg="로그아웃 하시겠습니까?"><i class="fa fa-sign-out"></i></a> </span>
				</div>
				<!-- end logout button -->
				...
				<div id="digital-clock" class="header-dropdown-list hidden-xs pull-right">
                    <li><a href="javascript:void(0);" class="dropdown-toggle"><span id="clock"></span></a></li>
				</div>
		...
		<aside id="left-panel">
			...
			<div class="login-info">
				<span> <!-- User image size is adjusted inside CSS, it should stay as it -->
						<a href="javascript:void(0);" id="show-shortcut" data-action="toggleShortcut">
						<%--<img src="../img/avatars/5.png" alt="me" class="online" />--%>
						<span>
			...
			<nav>
				<ul>
					<li class="active">
						<a href="../-at-lo-pg/-home.sh" title="데쉬 보드" id="mDashBoard"><i class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">데쉬 보드</span></a>
					</li>
					<li>
						<a href="#"><i class="fa fa-lg fa-fw fa-desktop"></i> <span class="menu-item-parent">이벤트 관리</span></a>
						<ul>
							<li>
								<a href="../-at-lo-pg/-event_list.sh">이벤트 목록</a>
							</li>
<!-- 							<li> -->
<!-- 								<a href="../-at-lo-pg/-eventCtl_list.sh">이벤트별 제어정보</a> -->
<!-- 							</li> -->
						</ul>
					</li>
					<li>
						<a href="#"><i class="fa fa-lg fa-fw fa-bar-chart-o"></i> <span class="menu-item-parent">전력 사용량</span></a>
						<ul>
							<li>
								<a href="../-at-lo-pg/-search_powerCBL_list.sh">CBL 정보</a>
							</li>
							<li>
								<a href="../-at-lo-pg/-search_powerKep_list.sh">한전 검침 정보</a>
							</li>
							<li>
								<a href="../-at-lo-pg/-search_power_list.sh">스마트미터 검침 정보</a>
							</li>
						</ul>
					</li>
					<li>
						<a href="#"><i class="fa fa-lg fa-fw fa-flag-checkered"></i> <span class="menu-item-parent">수용가 관리</span></a>
						<ul>
							<li>
								<a href="../-at-lo-pg/-custView.sh">수용가 정보</a>
							</li>
							<li>
								<a href="../-at-lo-pg/-custMeter_list.sh">스마트미터 정보</a>
							</li>
						</ul>
					</li>
					<li>
						<a href="#"><i class="fa fa-lg fa-fw fa-user"></i> <span class="menu-item-parent">사용자 관리</span></a>
						<ul>
							<li>
								<a href="../-at-lo-pg/-userList.sh">사용자 관리</a>
							</li>
							<li>
								<a href="../-at-lo-pg/-userChange_form.sh">개인정보 관리</a>
							</li>
						</ul>
					</li>
					<li>
						<a href="#"><i class="fa fa-lg fa-fw fa-tasks"></i> <span class="menu-item-parent">시스템 관리</span></a>
						<ul>
							<li>
								<a href="../-at-lo-pg/-scheduleList.sh">연동상태 관리</a>
							</li>
							<li>
								<a href="../-at-lo-pg/-searchLogFile_list.sh">연동로그 관리</a>
							</li>
						</ul>
					</li>
                    <c:if test="${session['access_cls']=='B' }" >
                    <li>
						<a href="../-at-lo-pg/-userChange_form.sh"><i class="fa fa-lg fa-fw fa-lock"></i> <span class="menu-item-parent">개인정보 관리</span></a>
                    </li>
                    </c:if>
				</ul>
			</nav>
		...
		<div id="shortcut">
			<ul>
				<li>
					<a href="../-dr-home/.sh" class="jarvismetro-tile big-cubes selected bg-color-purple"> <span class="iconbox"> <i class="fa fa-play fa-5x"></i> <span>메인 </span> </a>
				</li>
				<%
				/*
				** 개발자 UI를 만드는 것은 업무롤 밖이다.
				<li>
					<a href="../-dr-admin/.sh" class="jarvismetro-tile big-cubes bg-color-orangeDark"> <span class="iconbox"> <i class="fa fa-gears fa-5x"></i> <span>개발</span> </span> </a>
				</li>
				*/
				%>
			</ul>
        ...
        <script src="../jquery/jqClock/jqClock.js"></script>
		...
		<script src="../js/AModal.js"></script>
		<script src="../js/AUtils.js"></script>
		<script src="../js/ATimer.js"></script>
		...
		<script type="text/javascript">
            ...
            $(document).ready(function(){
                $("#clock").clock({"format":"24","calendar":"true"});
            });
		</script>
