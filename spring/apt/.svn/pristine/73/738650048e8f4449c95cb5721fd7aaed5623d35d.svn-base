...
public class EventDescriptor implements Serializable, Equals, HashCode, ToString
{
     ...
     * 
     */
    public EventDescriptor(final String eventID, final long modificationNumber, final Long priority, final EiMarketContext eiMarketContext, final DateTime createdDateTime, final EventStatusEnumeratedType eventStatus, final String testEvent, final String vtnComment) {
