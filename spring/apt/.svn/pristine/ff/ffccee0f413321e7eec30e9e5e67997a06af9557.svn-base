 ...
 * 
 * @see XMLNS
 * @see net.ion.open.oadr2.xmpp.OADR2NamespacePrefixMapper
 * @see com.sun.xml.bind.marshaller.NamespacePrefixMapper
 * @author tnichols
 */
public class OADR2NamespacePrefixMapper extends net.ion.open.oadr2.xmpp.OADR2NamespacePrefixMapper {
