...
<%//------------------------------------------------------------------------%>
	...
	<div class="unit_page" type="page" >
		<form id="form_" action="" method="post" enctype="multipart/form-data">
			...
			<input type="hidden" name="ui_id" value="powerM_sts">
...
<div id="${chartId }" style="margin:0px auto; height: 100%; width: 85%; max-height: 400px; min-height: 200px;"></div><div class="sheet" style="margin: 10px auto; display: none;"><br>
						<table class="lst" border="0" cellspacing="0" cellpadding="0"  style="margin-bottom: 10px;">
							<tr><th class="" style="" label="gbn" width="10">gbn</th><th class="hide_mb hide_web" style="" label="measure_date_x" width="10">measure_date_x</th><th class="" style="" label="measure_date" width="10">measure_date</th><th class="" style="" label="power_consumption" width="10">power_consumption</th><th class="hide_mb hide_web" style="" label="power_consumption_" width="10">power_consumption_</th></tr><%%>
			<c:forEach var="row" items="${rows }" varStatus="status">
	<tr class="row_${status.index + 1}">
		<td class="" style="" align="">
							<src:mk_field name="gbn" values="${row }" isSearch="false" type="lblFld" link=""  link_type="linkLoad" valid="notempty" valid2=""  keyValid="" maxlength="2" label="gbn" /> 
						</td>
					<td class="hide_mb hide_web" style="" align="">
							<src:mk_field name="measure_date_x" values="${row }" isSearch="false" type="xFld" link=""  link_type="linkLoad" valid="notempty" valid2=""  keyValid="" maxlength="2" label="measure_date_x" /> 
						</td>
					<td class="" style="" align="">
							<src:mk_field name="measure_date" values="${row }" isSearch="false" type="text_view" link=""  link_type="linkLoad" valid="notempty" valid2=""  keyValid="" maxlength="6" label="measure_date" /> 
						</td>
					<td class="" style="" align="right">
							<src:mk_field name="power_consumption" values="${row }" isSearch="false" type="number_view" link=""  link_type="linkLoad" valid="notempty" valid2=""  keyValid="" maxlength="42" label="power_consumption" /> 
						</td>
					<td class="hide_mb hide_web" style="" align="">
...
<%//[[END_AUTO_GENERATED_SRC]]1538153671[[HASHCODE]]%>
