			...
			<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
				...
				<div>
					...
					<div class="widget-body no-padding">
                        ...
                        <input type="hidden" name="ui_id" value="eventCtl_list">
						...
						<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
							...
							<c:forEach var="row" items="${rows }" varStatus="status">
								<tr>
									<td><src:mk_field name="event_id" values="${row }" isSearch="false" type="text_view" link="'eventCtlInfp',{event_id:'${'$'}{event_id}'}"  link_type="linkPopup" valid="" valid2=""  keyValid="" maxlength="30" label="이벤트ID" /></td>
									...
									<td><src:mk_field name="meter_ctl_snd_date" values="${row }" isSearch="false" type="datetime_view" link=""  link_type="linkLoad" valid="notempty" valid2=""  keyValid="" maxlength="19" label="제어신호전송일" /> </td>
