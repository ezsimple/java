...
public class SignatureProperties implements Serializable, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            strategy.appendField(locator, this, "signatureProperties", buffer, theSignatureProperties);
        }
        {
            String theId;
            theId = this.getId();
