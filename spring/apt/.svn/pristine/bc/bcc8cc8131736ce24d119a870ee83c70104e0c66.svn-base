...
public class Signature implements Serializable, Equals, HashCode, ToString
{
     ...
     * 
     */
    public Signature(final SignedInfo signedInfo, final SignatureValue signatureValue, final KeyInfo keyInfo, final List<Object> objects, final String id) {
