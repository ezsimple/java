...
public class Entry implements Serializable, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            strategy.appendField(locator, this, "authorsAndCategoriesAndContents", buffer, theAuthorsAndCategoriesAndContents);
        }
        {
            String theBase;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final Entry that = ((Entry) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "authorsAndCategoriesAndContents", lhsAuthorsAndCategoriesAndContents), LocatorUtils.property(thatLocator, "authorsAndCategoriesAndContents", rhsAuthorsAndCategoriesAndContents), lhsAuthorsAndCategoriesAndContents, rhsAuthorsAndCategoriesAndContents)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            List<Object> theAuthorsAndCategoriesAndContents;
            theAuthorsAndCategoriesAndContents = (((this.authorsAndCategoriesAndContents!= null)&&(!this.authorsAndCategoriesAndContents.isEmpty()))?this.getAuthorsAndCategoriesAndContents():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "authorsAndCategoriesAndContents", theAuthorsAndCategoriesAndContents), currentHashCode, theAuthorsAndCategoriesAndContents);
        }
        {
            String theBase;
            theBase = this.getBase();
