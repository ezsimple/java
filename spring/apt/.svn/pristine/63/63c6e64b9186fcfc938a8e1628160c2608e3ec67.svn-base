...
import net.ion.open.oadr2.model.v20b.emix.ServiceArea;
import net.ion.open.oadr2.model.v20b.power.AggregatedPnode;
import net.ion.open.oadr2.model.v20b.power.EndDeviceAsset;
import net.ion.open.oadr2.model.v20b.power.MeterAsset;
import net.ion.open.oadr2.model.v20b.power.Pnode;
import net.ion.open.oadr2.model.v20b.power.ServiceDeliveryPoint;
import net.ion.open.oadr2.model.v20b.power.ServiceLocation;
import net.ion.open.oadr2.model.v20b.power.TransportInterface;
...
public class EiTarget implements Serializable, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            strategy.appendField(locator, this, "aggregatedPnodes", buffer, theAggregatedPnodes);
        }
        {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "serviceAreas", buffer, theServiceAreas);
        }
        {
            ...
            strategy.appendField(locator, this, "serviceDeliveryPoints", buffer, theServiceDeliveryPoints);
        }
        {
            ...
            strategy.appendField(locator, this, "serviceLocations", buffer, theServiceLocations);
        }
        {
            ...
            strategy.appendField(locator, this, "transportInterfaces", buffer, theTransportInterfaces);
        }
        {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "groupNames", buffer, theGroupNames);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final EiTarget that = ((EiTarget) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "aggregatedPnodes", lhsAggregatedPnodes), LocatorUtils.property(thatLocator, "aggregatedPnodes", rhsAggregatedPnodes), lhsAggregatedPnodes, rhsAggregatedPnodes)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "endDeviceAssets", lhsEndDeviceAssets), LocatorUtils.property(thatLocator, "endDeviceAssets", rhsEndDeviceAssets), lhsEndDeviceAssets, rhsEndDeviceAssets)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "meterAssets", lhsMeterAssets), LocatorUtils.property(thatLocator, "meterAssets", rhsMeterAssets), lhsMeterAssets, rhsMeterAssets)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "pnodes", lhsPnodes), LocatorUtils.property(thatLocator, "pnodes", rhsPnodes), lhsPnodes, rhsPnodes)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "serviceAreas", lhsServiceAreas), LocatorUtils.property(thatLocator, "serviceAreas", rhsServiceAreas), lhsServiceAreas, rhsServiceAreas)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "serviceDeliveryPoints", lhsServiceDeliveryPoints), LocatorUtils.property(thatLocator, "serviceDeliveryPoints", rhsServiceDeliveryPoints), lhsServiceDeliveryPoints, rhsServiceDeliveryPoints)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "serviceLocations", lhsServiceLocations), LocatorUtils.property(thatLocator, "serviceLocations", rhsServiceLocations), lhsServiceLocations, rhsServiceLocations)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "transportInterfaces", lhsTransportInterfaces), LocatorUtils.property(thatLocator, "transportInterfaces", rhsTransportInterfaces), lhsTransportInterfaces, rhsTransportInterfaces)) {
                return false;
            }
        }
        {
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "groupNames", lhsGroupNames), LocatorUtils.property(thatLocator, "groupNames", rhsGroupNames), lhsGroupNames, rhsGroupNames)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            List<AggregatedPnode> theAggregatedPnodes;
            theAggregatedPnodes = (((this.aggregatedPnodes!= null)&&(!this.aggregatedPnodes.isEmpty()))?this.getAggregatedPnodes():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "aggregatedPnodes", theAggregatedPnodes), currentHashCode, theAggregatedPnodes);
        }
        {
            List<EndDeviceAsset> theEndDeviceAssets;
            theEndDeviceAssets = (((this.endDeviceAssets!= null)&&(!this.endDeviceAssets.isEmpty()))?this.getEndDeviceAssets():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "endDeviceAssets", theEndDeviceAssets), currentHashCode, theEndDeviceAssets);
        }
        {
            List<MeterAsset> theMeterAssets;
            theMeterAssets = (((this.meterAssets!= null)&&(!this.meterAssets.isEmpty()))?this.getMeterAssets():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "meterAssets", theMeterAssets), currentHashCode, theMeterAssets);
        }
        {
            List<Pnode> thePnodes;
            thePnodes = (((this.pnodes!= null)&&(!this.pnodes.isEmpty()))?this.getPnodes():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "pnodes", thePnodes), currentHashCode, thePnodes);
        }
        {
            List<ServiceArea> theServiceAreas;
            theServiceAreas = (((this.serviceAreas!= null)&&(!this.serviceAreas.isEmpty()))?this.getServiceAreas():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "serviceAreas", theServiceAreas), currentHashCode, theServiceAreas);
        }
        {
            List<ServiceDeliveryPoint> theServiceDeliveryPoints;
            theServiceDeliveryPoints = (((this.serviceDeliveryPoints!= null)&&(!this.serviceDeliveryPoints.isEmpty()))?this.getServiceDeliveryPoints():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "serviceDeliveryPoints", theServiceDeliveryPoints), currentHashCode, theServiceDeliveryPoints);
        }
        {
            List<ServiceLocation> theServiceLocations;
            theServiceLocations = (((this.serviceLocations!= null)&&(!this.serviceLocations.isEmpty()))?this.getServiceLocations():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "serviceLocations", theServiceLocations), currentHashCode, theServiceLocations);
        }
        {
            List<TransportInterface> theTransportInterfaces;
            theTransportInterfaces = (((this.transportInterfaces!= null)&&(!this.transportInterfaces.isEmpty()))?this.getTransportInterfaces():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "transportInterfaces", theTransportInterfaces), currentHashCode, theTransportInterfaces);
        }
        {
            List<String> theGroupIDs;
            theGroupIDs = (((this.groupIDs!= null)&&(!this.groupIDs.isEmpty()))?this.getGroupIDs():null);
        ...
        }
        {
            List<String> theGroupNames;
            theGroupNames = (((this.groupNames!= null)&&(!this.groupNames.isEmpty()))?this.getGroupNames():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "groupNames", theGroupNames), currentHashCode, theGroupNames);
        }
        {
            List<String> theResourceIDs;
            theResourceIDs = (((this.resourceIDs!= null)&&(!this.resourceIDs.isEmpty()))?this.getResourceIDs():null);
